...
// //                 <img src="https://images.unsplash.com/photo-1581841064838-a470c740e8ee?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
// //               </div>
// //               <p>Username</p>
// //             </div>

// //             <img src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8cG90cmFpdCUyMGZpcmx8ZW58MHx8MHx8fDA%3D" alt="" />
...
// //                   <button><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2.58582L18.2071 8.79292L16.7929 10.2071L13 6.41424V16H11V6.41424L7.20711 10.2071L5.79289 8.79292L12 2.58582ZM3 18V14H5V18C5 18.5523 5.44772 19 6 19H18C18.5523 19 19 18.5523 19 18V14H21V18C21 19.6569 19.6569 21 18 21H6C4.34315 21 3 19.6569 3 18Z"></path></svg></button>
// //                 </div>
// //                 <div className="right">
...
// //                 </div>
// //               </div>
// //               <p className="caption">Lorem ipsum, dolor sit amet consectetur adipisicing elit.</p>
// //             </div>
// //          </div>
// //   )
// // }
...
//         <div className="img-wrapper">
//           <img 
//             src="https://images.unsplash.com/photo-1581841064838-a470c740e8ee?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
//             alt="User avatar" 
//           />
//         </div>
//         <p>Username</p>
...
//       <img 
//         src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8cG90cmFpdCUyMGZpcmx8ZW58MHx8MHx8fDA%3D" 
//         alt="Post content" 
//       />
    ...
    <article className="post">
      ...
      <div className="bottom">
        <div className="icons">
          <div className="left">
            {/* Like */}
            <button className={post.isLiked?"like":""} aria-label="Like">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
